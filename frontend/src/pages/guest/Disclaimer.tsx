            ...
            <section className="w-full flex text-gray-300 flex-col pt-28 lg:px-20 md:px-12 px-4">
                ...
                <div className="mt-4 md:mt-7 mb-20">
                    <div>
                        ...
                        <p className="font-barlow text-gray-400 md:mt-1 text-sm md:text-base">Strimz Token Streaming Platform does not provide investment, financial, or legal advice. The content provided on this platform, including but not limited to articles, guides, and tutorials, is for informational purposes only. Users are solely responsible for their own investment decisions and should seek professional advice where necessary.</p>

                        <h2 className="font-belanosima text-gray-200 text-lg mt-3 md:mt-5 md:text-2xl lg:text-3xl">No Guarantee of Results</h2>
                        <p className="font-barlow text-gray-400 md:mt-1 text-sm md:text-base">While we strive to provide accurate and up-to-date information, Strimz Token Streaming Platform makes no guarantees or representations regarding the accuracy, reliability, or completeness of the content available on the platform. We do not guarantee any specific results or outcomes from using the platform.</p>

                        <h2 className="font-belanosima text-gray-200 text-lg mt-3 md:mt-5 md:text-2xl lg:text-3xl">Limitation of Liability</h2>
                        <p className="font-barlow text-gray-400 md:mt-1 text-sm md:text-base">In no event shall Strimz Token Streaming Platform, its affiliates, partners, or contributors be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in any way connected with your use of the platform, whether based on contract, tort, strict liability, or any other legal theory, even if we have been advised of the possibility of such damages.</p>

                        <h2 className="font-belanosima text-gray-200 text-lg mt-3 md:mt-5 md:text-2xl lg:text-3xl">Indemnification</h2>
                        <p className="font-barlow text-gray-400 md:mt-1 text-sm md:text-base">You agree to indemnify and hold harmless Strimz Token Streaming Platform, its affiliates, partners, and contributors from any claims, damages, liabilities, costs, or expenses arising out of your use of the platform or violation of these terms.</p>
                        <p className="font-barlow text-gray-400 md:mt-2 mt-1 text-sm md:text-base">Every effort is made to keep the website up and running smoothly. However, Strimz takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
                        ...
                        <p className="text-gray-400 font-barlow">
                            If you have any questions or concerns about these disclaimer, please contact us at: <span className="text-blue-500 cursor-pointer"><a href="mailto:team.Strimzstream@gmail.com">team.Strimzstream@gmail.com</a></span>
                        </p>
