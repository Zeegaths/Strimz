        ...
        <main className="relative min-h-screen flex flex-col">
            ...
            <section className="w-full flex text-gray-300 flex-col pt-28 lg:px-20 md:px-12 px-4">
                ...
                <div className="mt-7 mb-20">
                    <div>
                        <p className="font-barlow text-gray-400  text-sm md:text-lg"><span className="bg-gradient-to-r from-sky-400 font-belanosima to-purple-500 text-transparent bg-clip-text">Strimz</span> is committed to protecting the privacy and security of your personal information. This Privacy Policy outlines how we collect, use, disclose, and protect your information when you use our token streaming application.</p>
                        ...
                        <div className="mt-7">
                            ...
                            <ul className="flex flex-col gap-2 text-gray-400 font-barlow">
                                {
                                    features6.map(({ caption, text }, index) => (
                                        <li key={index} className="flex mt-2 items-start gap-2">
                                            ...
                                            <p className="text-gray-400"><span className="text-gray-300 font-belanosima">{caption}:</span> {text} <span className="text-blue-500 cursor-pointer"><a href="mailto:team.Strimzstream@gmail.com">team.Strimzstream@gmail.com</a></span></p>
                                        </li>
                                    ))
                                }
                            </ul>
                            ...
                            <div className="ml-7 mt-3">
                                ...
                                <p className="font-belanosima flex mt-1 text-lg gap-2">Thank You for using <span onClick={() => navigate('/')} className="bg-gradient-to-r from-sky-400 cursor-pointer to-purple-500 font-belanosima text-transparent mt-1 text-3xl bg-clip-text">Strimz</span></p>
                            </div>
                        </div>
