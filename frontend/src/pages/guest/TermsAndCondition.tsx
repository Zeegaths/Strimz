...
const TermsAndCondition = () => {
    ...
    const features: { caption: string, text: string }[] = [
        {
            caption: "Termination",
            text: "Strimz Token Streaming Platform reserves the right to suspend or terminate user accounts or access to the platform at any time, without prior notice or liability, for any reason."
        },
        {
            ...
            <section className="w-full flex text-gray-300 flex-col pt-28 lg:px-20 md:px-12 px-4">
                ...
                <div className="mt-5 mb-16">
                    <p className="font-barlow text-gray-400 pt-3">
                        Welcome to Strimz Token Streaming Platform! By accessing or using our platform, you agree to comply with and be bound by the following terms and conditions. Please read these terms carefully before using the platform. If you do not agree with any part of these terms, you may not access or use the platform.
                    </p>
                    ...
                    <div className="">
                        ...
                        <div>
                            ...
                            <div className="md:flex mt-5 md:gap-3">
                                ...
                                <div className="">
                                    <h2 className="font-belanosima text-lg">Strimz's Obligation</h2>
                                    <ul className="list-disc ml-4 mt-2">
                                        <li className="font-belanosima mb-2 text-base text-gray-200">Service Availability: <span className="font-barlow text-sm text-gray-400">Strimz Token Streaming Platform makes reasonable efforts to ensure that the platform is available and accessible to users at all times. However, we do not guarantee uninterrupted access or operation of the platform.</span></li>
                                        ...
                                        <li className="font-belanosima mb-2 text-base text-gray-200">Privacy Protection: <span className="font-barlow text-sm text-gray-400">Strimz collect, use, and disclose user data in accordance with our Privacy Policy. We are committed to protecting the privacy and security of user information.</span></li>
                                ...
                                <div className="mt-10 md:mt-0 ">
                                    ...
                                    <ul className="list-disc ml-4 mt-2">
                                        <li className="font-belanosima mb-2 text-base text-gray-200">Compliance with Terms: <span className="font-barlow text-sm text-gray-400">Users agree to comply with these terms and conditions and any additional policies or guidelines provided by Strimz Token Streaming Platform.</span></li>
                                        ...
                                        <li className="font-belanosima mb-2 text-base text-gray-200">Respect for Intellectual Property: <span className="font-barlow text-sm text-gray-400">Users agree to respect the intellectual property rights of Strimz Token Streaming Platform and other users, including copyrights, trademarks, and patents.</span></li>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 font-barlow mt-1">
                            Thank you for reviewing our terms and conditions. By using the Strimz Token Streaming Platform, you agree to be bound by the terms outlined in this document.
                        </p>

                        <p className="text-gray-400 font-barlow">
                            If you have any questions or concerns about these terms and conditions, please contact us at: <span className="text-blue-500 cursor-pointer"><a href="mailto:team.Strimzstream@gmail.com">team.Strimzstream@gmail.com</a></span>
                        </p>
                        ...
                        <p className="font-belanosima mt-1 flex text-lg gap-2">Thank You for using <span onClick={() => navigate('/')} className="bg-gradient-to-r from-sky-400 cursor-pointer to-purple-500 font-belanosima text-transparent mt-1 text-3xl bg-clip-text">Strimz</span></p>
                    </div>
                </div>
            </section>
        </main>
