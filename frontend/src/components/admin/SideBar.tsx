                            ...
                            {/* <!-- Menu Item Calendar --> */}
                            {
                                NavLinks.map((link, index) => (
                                    <li key={index}>
                                        <NavLink
                                            to={link.url}
                                            className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 text-gray-300 duration-300 ease-in-out before:absolute before:left-0 before:top-0 before:w-0.5 before:transition-all before:duration-200  before:bg-purple-500 hover:before:h-full ${pathname === link.url ?
