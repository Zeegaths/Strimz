...
const services: ServiceTypes[] = [
    {
        ...
        description: 'Strimz offers a robust subscription management service, allowing businesses to automate recurring payments and manage subscription tiers effortlessly.',
        url: '/onboarding/subscription',
        img: SubscriptionImg
    },
    {
        caption: 'Salary Distributions',
        description: "Simplify salary distributions with Strimz's automated service.Calculate pro- rata payments accurately and streamline payroll processes for your employees.",
