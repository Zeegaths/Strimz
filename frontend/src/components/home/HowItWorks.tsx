    ...
    const steps: { caption: string, text: string, icon: JSX.Element }[] = [
        {
            ...
            text: "Before you can start streaming tokens, securely authenticate your account using industry-standard authentication methods. Ensure the safety of your financial data with Strimz's robust security measures.",
            ...
            text: "Once you've configured your stream to your satisfaction, activate it to start the token flow. Sit back and watch as Strimz handles the rest, ensuring that your tokens are distributed smoothly and efficiently according to your predefined criteria.",
            icon: <SlPower />,
        }, {
            caption: "Manage Your Stream",
            text: "Monitor and manage your token stream with ease using Strimz's intuitive interface. Pause, modify, or stop your stream as needed, and track your transaction history to stay informed about your financial activities.",
            icon: <LuSettings2 />,
        }, {
            caption: "Enjoy Seamless Automation",
            text: "With Strimz, you can enjoy the benefits of seamless financial automation without the hassle of manual intervention. Whether you're distributing salaries, rewarding users, or managing subscriptions, Strimz streamlines the process for maximum efficiency and convenience.",
            icon: <RxUpdate />,
        }
    ]
    return (
        <main className='w-full flex flex-col items-center md:my-24 my-20 lg:px-20 md:px-16 px-4'>
            ...
            <p className="text-gray-400 font-barlow text-center md:w-[50%]">Strimz makes token streaming easy and efficient, allowing you to automate financial processes with just a few simple steps:</p>
