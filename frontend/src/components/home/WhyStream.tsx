    ...
    const features: { caption: string, text: string }[] = [
        {
            ...
            text: "Strimz enables users to set up automated token streams for various purposes, including salaries, rewards, subscriptions, and more."
        },
        {
        ...
        },
        {
            ...
            text: "Built on the Optimism blockchain and rigorously tested for security and efficiency, Strimz ensures the safety of your transactions and the reliability of your financial operations."
        }
    ]
    return (
        <main className='w-full flex flex-col items-start my-24'>
            <div className="w-full grid md:grid-cols-2 gap-20 lg:px-28 px-4">
                ...
                <div className="flex flex-col order-2 md:order-1 items-start gap-1.5">
                    <h1 className="text-3xl text-gray-200 font-belanosima">Why Strimz</h1>
                    <p className="text-gray-400 font-barlow">With Strimz, you can say goodbye to manual transaction processes and hello to a new era of financial automation. Whether you're an individual looking to streamline your personal finances or a business seeking to optimize your operations, Strimz offers the tools and capabilities you need to succeed in the world of DeFi.</p>
